...
export const addCar = async (req, res)=>{
    try {
        ...
        // For URL generation, works for both images and videos optimization through imagekit URL transformation
...
export const toggleCarAvailability = async (req, res) =>{
     try {
        ...
        //checking does the car belong to the user
...
export const getDashboardData = async (req, res) => {
    try {
        ...
        const cars = await Car.find({owner: _id})
        let bookings = await Booking.find({owner: _id}).populate('car').sort({createdAt: -1});
        ...
        const dashboardData = {
            ...
            pendingBookings: pendingBookings.length, // Now derived from the filtered list
